...
while True:
        ...
        # sentence_2 = 'Science Technology discovery.'          # Sentence is okey: 99%
        sentence_2 = 'Science Technology and Internet.'      # Sentence is okey: 4%
        ...
        print('Sentence is similar:', int(round(predicts[0][0]*100)), '%')                    # [[0.9657724  0.03422766]] - левое число вероятность что второе предложение подходит по смыслу, а правое - что второе предложение случайное
